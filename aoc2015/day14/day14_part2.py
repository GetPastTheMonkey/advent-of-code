...
for i in range(race_duration):
    ...
    current_lead = max(map(lambda x: x.get_distance(), reindeer_list))
    for r in reindeer_list:
        r.award_point(current_lead)

print(max(map(lambda x: x.get_points(), reindeer_list)))
